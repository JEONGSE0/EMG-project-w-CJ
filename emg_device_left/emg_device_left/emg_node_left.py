...
DEFAULT_SERVICE_UUID = "12345679-1234-5678-1234-123456789abc"
DEFAULT_CHAR_UUID    = "abcdef13-3456-789a-bcde-f123456789ab"
NUM_CHANNELS = 8
...
class EmgBleNodeLeft(Node):
    def __init__(self):
        super().__init__('emg_ble_node_left')
        ...
        self.declare_parameter('topic', '/emg/signal_left')
        ...
        self.ble_status_pub = self.create_publisher(String, '/emg/left/ble_status', 10)
