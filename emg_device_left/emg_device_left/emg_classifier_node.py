...
# ---------------------------
try:
    from emg_device_left.config import (
        FS as CFG_FS,
    ...
    from emg_device_left.ring_buffer import RingBuffer
    from emg_device_left.features import compute_features
    from emg_device_left.decision import DecisionLayer, DecisionState
except Exception:
...
try:
    from emg_device_left.real_time_filter import RealtimeFilter  # type: ignore
    _HAS_FILTER = True
...
class EmgClassifierNodeLeft(Node):
    def __init__(self) -> None:
        super().__init__("emg_classifier_node_left")
        ...
        self.declare_parameter("input_topic", "/emg/signal_left")
        ...
        self.declare_parameter("model_filename", "re_model_2.joblib")
        ...
        self.declare_parameter("gesture_conf_topic", "/emg/gesture_confidence_left")
        self.declare_parameter("publish_probs", False)
        self.declare_parameter("gesture_probs_topic", "/emg/gesture_probs_left")
        self.declare_parameter("filtered_topic", "/emg/signal_filtered_left")
        ...
        self.warmup_pub = self.create_publisher(Int32, '/emg/left/warmup_remaining', 10)
        ...
        if not os.path.isfile(model_path):
            raise FileNotFoundError(
                ...
                f"(hint) if running from source, pass -p model_path:=/home/meow/ros2_ws/src/emg_device_left/emg_device_left/models/re_model_2.joblib "
