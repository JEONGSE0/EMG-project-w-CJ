...
class JointStateToJson(Node):
    def __init__(self):
        super().__init__("so101_real_control_right")

        # ---- params ----
        self.declare_parameter("in_topic", "/so101/joint_states_right")
        self.declare_parameter("out_path", "/home/gkim451/ros2_ws/src/so101/gkim/demo/cmd1.json")
